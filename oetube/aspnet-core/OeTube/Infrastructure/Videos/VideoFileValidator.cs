...
namespace OeTube.Infrastructure.Videos
{
    public class VideoFileValidator : IVideoFileValidator, ITransientDependency
    {
        private VideoFileConfig _config;

        public VideoFileValidator(IVideoFileConfigFactory videoFileConfigFactory)
        {
            _config = videoFileConfigFactory.Create();
        }
